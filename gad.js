...
function outputEncode(a) {
    ...
    setTimeout(function () {
        exec("cp gad.js temp/seqer_versions/seqer_"+dateTime+".js; cp temp/seq.txt temp/seq_versions/seq_"+dateTime+".txt;");
    }, 100);
...
// INITIALIZING
console.clear();
exec('mkdir temp temp/frames temp/seq_versions exports temp/seqer_versions');
